<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Deault.aspx.cs" Inherits="PapaBobs.Web.Deault" %>
...
<body>
    ...
    <div class="container">
       ...
       <div class="form-group">
        ...
        <div class="radio"><label><asp:RadioButton ID="creditRadioButton" runat="server" GroupName="PaymentGroup"/>Credit</label></div>                                                   </label></div>
